...
var TABLE_NAME = "rentalTransactionDB";
...
exports.addATransaction = function(req, res) {
...
exports.updateATransaction = function(req, res) {
...
exports.deleteATransaction = function(req, res) {
    var params = {
        TableName: TABLE_NAME,
        Key: {
            ID: req.body.transId
